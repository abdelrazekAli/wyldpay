...
const Menu = () => {
    // Category filters
    const filteredPizzas = dummyData_1.mainProducts.filter((p) => p.category === "pizzas");
    const filteredBurgers = dummyData_1.mainProducts.filter((p) => p.category === "burgers");
    const filteredChickens = dummyData_1.mainProducts.filter((p) => p.category === "chickens");
    const filteredLunch = dummyData_1.mainProducts.filter((p) => p.category === "lunch");
    const filteredDrinks = dummyData_1.mainProducts.filter((p) => p.category === "drinks");
    const filteredPopular = dummyData_1.mainProducts.filter((p) => p.category === "popular");
    return (<div id="menu">
      ...
      <section className="popular mb-3" id="pizzas">
        ...
        <div className="box-container">
          {filteredPizzas.map((p) => (<MainBox_1.MainBox key={p.id} product={p}/>))}
        </div>
        ...
        <div className="box-container">
          {filteredBurgers.map((p) => (<MainBox_1.MainBox key={p.id} product={p}/>))}
        </div>
        ...
        <div className="box-container">
          {filteredChickens.map((p) => (<MainBox_1.MainBox key={p.id} product={p}/>))}
        </div>
        ...
        <div className="box-container">
          {filteredLunch.map((p) => (<MainBox_1.MainBox key={p.id} product={p}/>))}
        </div>
        ...
        <div className="box-container">
          {filteredDrinks.map((p) => (<MainBox_1.MainBox key={p.id} product={p}/>))}
        </div>
        ...
        <div className="box-container">
          {filteredPopular.map((p) => (<MainBox_1.MainBox key={p.id} product={p}/>))}
        </div>
      </section>
