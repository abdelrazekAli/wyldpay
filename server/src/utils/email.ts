...
export const sendRegisterEmail = (email: string, token: string) => {
  ...
  const mailOptions = {
    ...
    html: `<div style="margin: 0px auto; max-width: 600px;">
        ...
        <tr>
        <td style="font-size: 0px; padding: 0px; border-collapse: collapse; word-break: break-word;" align="center">
        <div style="font-family: 'Euclid Circular A',helvetica,sans-serif; font-size: 14px; font-weight: 400; line-height: 140%; text-align: center; color: #192033;">Click the button below to redirect you to register process.</div>
        </td>
        </tr>
        </tbody>
        </table>
